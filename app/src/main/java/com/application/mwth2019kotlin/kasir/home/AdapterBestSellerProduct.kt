...
import kotlinx.android.synthetic.main.template_product_bestselling.*
...
class AdapterBestSellerProduct(private var data: MutableList<ModelBestSellerProduct>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return LayoutInflater.from(parent.context)
                .inflate(R.layout.template_product_bestselling, parent, false).let {
