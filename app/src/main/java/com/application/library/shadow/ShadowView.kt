package com.application.library.shadow
...
import com.application.library.shadow.ShapeUtils
...
open class ShadowView @JvmOverloads constructor(context: Context?, attributeSet: AttributeSet? = null, defStyleInt: Int = 0)
    ...
    init {
        ...
        shadowDx = a.getFloat(R.styleable.ShadowView_shadowDxa, 0f)
        shadowDy = a.getFloat(R.styleable.ShadowView_shadowDya, 1f)
